    ...
    <AnimatePresence mode='wait'>
      <div className='fixed top-0 z-20 w-screen'>
        {isMobile && (
          <motion.div
            {...slideAnimation('down')}
            className='text-[9px] py-2 px-4  bg-accent  backdrop-blur-md font-semibold shadow-card'
          >
            Portfolio V3, Also currently working on useeducator.com and braille
            ayo
          </motion.div>
        )}

        <nav
          className={`${styles.paddingX}  flex items-center py-6  bg-[transparent] backdrop-blur-md `}
        >
